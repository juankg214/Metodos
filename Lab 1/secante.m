...
f = inline ( fun,'x'); #Se crea la funciÃ³n
...
while(i<=itemax)#Mientras que el nÃºmero de iteracciones sea menor al nÃºmero de iteracciones maximas:
  %Interseccion en el eje X; Y = 0
  p=p1-q1*(p1-p0)/(q1-q0);#Aplicamos la ecuacion predefinida para la fÃ³rmula de la secante con las distinta variables ya creadas (p0,p1,q0,q1)
